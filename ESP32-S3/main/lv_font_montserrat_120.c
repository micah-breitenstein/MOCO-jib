 ...
 * Size: 100 px
 * Bpp: 4
 * Opts: --no-compress --format lvgl --bpp 4 --font managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 100 -r 0x20,0x43,0x4d,0x4f,0x62,0x69,0x6a -o main/lv_font_montserrat_120.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1157, .box_w = 65, .box_h = 73, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 2373, .adv_w = 1528, .box_w = 75, .box_h = 71, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 5036, .adv_w = 1344, .box_w = 76, .box_h = 73, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 7810, .adv_w = 1091, .box_w = 55, .box_h = 76, .ofs_x = 9, .ofs_y = -1},
    {.bitmap_index = 9900, .adv_w = 446, .box_w = 14, .box_h = 77, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 10439, .adv_w = 454, .box_w = 31, .box_h = 97, .ofs_x = -10, .ofs_y = -21}
};
