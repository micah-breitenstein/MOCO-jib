...
constexpr unsigned long INTERVAL_RUMBLE_LONG_MS = 900;
constexpr unsigned long INTERVAL_RUMBLE_LONG_PAUSE_MS = 500;
constexpr unsigned long INTERVAL_RUMBLE_GROUP_SEPARATOR_MS = 600;
constexpr unsigned long INTERVAL_RUMBLE_SHORT_ON_MS = 300;
constexpr unsigned long INTERVAL_RUMBLE_SHORT_TOTAL_MS = 500;
