...
constexpr int DRONE_SPEED_TIER_MED_THRESHOLD = 28;
constexpr int DRONE_SPEED_TIER_HIGH_THRESHOLD = 92;
constexpr int DRONE_STICK_MAX_DEFLECTION = 127;
constexpr uint8_t DRONE_EXPO_PERCENT = 45;
...
constexpr unsigned long DRONE_MANUAL_TIER_STEP_INTERVAL_MS = 150;
